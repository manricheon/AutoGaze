...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| longvila_r1 | missing | True | True | False | False | True | True | missing processor/tokenizer files: ['preprocessor_config.json', 'tokenizer_config.json']; weights missing or incomplete |
