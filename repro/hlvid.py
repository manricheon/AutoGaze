...
PROCESSING_BUDGET_SUMMARY_FIELDS = (
    ...
    "video.resize_enabled",
    "video.resize_request",
    "video.requested_video_frames",
    "video.actual_video_frames",
    "model_processing_unit.name",
    "model_processing_unit.tile_size_px",
    "tiling.spatial_tiles_per_frame",
    "tiling.tile_frame_instances",
    "thumbnail.enabled",
    "thumbnail.actual_frames",
    "thumbnail.policy",
    "single_scale_dense_vision_budget.comparison_scope",
    "single_scale_dense_vision_budget.patch_positions_per_tile_frame",
    "single_scale_dense_vision_budget.patch_positions_per_reference_tile_frame",
    ...
    "single_scale_dense_vision_budget.ratio_over_autogaze_selected_total_patch_tokens",
    "single_scale_dense_vision_budget.ratio_over_estimated_visual_tokens_after_prune",
    ...
    "patch_budget_before_siglip.removed_total_patch_tokens",
    "patch_budget_before_siglip.total_patch_reduction_ratio",
    "patch_budget_before_siglip.total_patch_reduction_percent",
    "patch_budget_before_vit.estimated_total_frames_in_processor",
    ...
    "llm_visual_budget.removed_visual_tokens_estimated",
    "llm_visual_budget.visual_token_reduction_ratio",
    "llm_visual_budget.visual_token_reduction_percent",
)
COMPUTE_FIELDS = (
